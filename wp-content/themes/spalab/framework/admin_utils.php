...
function dttheme_default_option() {
	...
	$general = array(
				...
				"copyright-text" => 'Copyright &copy; 2014 Spa Lab Theme All Rights Reserved | <a href="http://themeforest.net/user/designthemes" title=""> Design Themes </a>');

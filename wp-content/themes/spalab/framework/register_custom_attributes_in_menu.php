            ...
            <li id="menu-item-<?php echo $item_id; ?>" class="<?php echo implode(' ', $classes ); ?>">
                ...
                <p class="filed-dt-fullwidth description description-thin">
                	<label for="edit-menu-item-dt-fullwidth<?php echo $item_id; ?>">
                        ...
                        <?php _e( 'Enable Fullwidth' ,  'dt_themes' ); ?>
                    </label>
                </p>
                ...
                <p class="field-dt-menuicon description description-wide">
                	...
                	<input id="edit-menu-item-dt-menu-icon-<?php echo $item_id; ?>" class="widefat edit-menu-item-dt-menu-icon" type="text" name="dt-menu-icon[<?php echo $item_id;?>]" value="<?php echo esc_attr( $value );?>">

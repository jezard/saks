                            ...
                            <div class="bpanel-option-set">
                                ...
                                <ul class="menu-to-edit drag-list">
                                	<?php $t = is_array(dttheme_option('seo',$option['id'])) ? dttheme_option('seo',$option['id']) : array();
										 if(sizeof($t) > 0):
										 	foreach($t as $key):?>
                                                <li><label><input  type="checkbox" name="<?php echo $option["name"]."[".$option['id']."][]";?>" value="<?php echo esc_attr( $key );?>"
                    ...
                    <div class="<?php echo esc_attr( $last );?>">
                        	...
                        	<label>
                            	<input id="mytheme[seo][<?php echo $option['id'];?>]" type="checkbox" name="mytheme[seo][<?php echo $option['id'];?>]" 
                                	value="<?php echo esc_attr( $option['id'] );?>" <?php checked($option['id'],dttheme_option('seo',$option['id']));?> /> <?php echo $option['label'];?>
                            </label>

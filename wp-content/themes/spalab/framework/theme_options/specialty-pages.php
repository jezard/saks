...
<div id="specialty-pages" class="bpanel-content">
    ...
    <div class="bpanel-main-content">
         ...
         <?php $sub_menus = array(
					...
					array("title"=>__("Catalog",'dt_themes'), "link"=>"#catalog-archives"),
         ...
         <?php $posts_layout_array =   array( 'one-column'=>__("Single post per row.",'dt_themes'),'one-half-column'=>__("Two posts per row.",'dt_themes'));
                ...
                $tabs = array(
						...
						array(  "id"=>"catalog-archives", 
                                "layout-title"=>__("Catalog Custom Post's Category Archive Page Layout",'dt_themes'),
                                "layout-tooltip"=>__("You can choose between a left, right or no sidebar layout for the Catalog custom post's category Archive page.",'dt_themes'),
                                "post-layout-title" => __("Posts Layout",'dt_themes'),
                                "post-layout-tooltip"=>__("Your category archive results will use the layout you select below.",'dt_themes'),                                
                                "post-layouts" => array(
                                    'one-column'=>__("Single catalog item  per row.",'dt_themes'),
                                    'one-half-column'=>__("Two catalog items per row.",'dt_themes'))
                        ),

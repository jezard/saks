        ...
        <div id="appearance-menu" class="tab-content">
        	<div class="bpanel-box">
                ...
                <div class="box-content">
					...
					<div class="bpanel-option-set">
                    	<h6><?php _e('Enable SubMenu Hover Settings','dt_themes');?></h6>
                        <?php dttheme_switch(__("Enable SubMenu Hover Style",'dt_themes'),'appearance','submenu-hover');?>
                    	<p class="note"> <?php _e('Enable or Disable SubMenu Hover style settings','dt_themes');?>                      
                    </div>
                    ...
                    <div class="font-container">
                        ...
                        <div class="standard-font column one-column bpanel-option-set" <?php echo $show_menu_standard_font;?>>
                            ...
                            <div class="column one-half last bpanel-option-set">
                                <?php dttheme_standard_font_style( __('Sample Title Font Style', 'dt_themes'), 'mytheme[appearance][menu-standard-font-style]', 
                        ...
                        <div class="standard-font column one-column bpanel-option-set" <?php echo $show_body_standard_font;?>>
                            <div class="column one-half bpanel-option-set">
                                <?php dttheme_standard_font( __('Standard Font', 'dt_themes'), 'mytheme[appearance][body-standard-font]', 
															dttheme_option('appearance', 'menu-standard-font'));?></div>
                            <div class="column one-half last bpanel-option-set">
                                <?php dttheme_standard_font_style( __('Sample Title Font Style', 'dt_themes'), 'mytheme[appearance][body-standard-font-style]', 
                ...
                <div class="box-content">
                    ...
                    <div class="font-container">
                        ...
                        <div class="standard-font column one-column bpanel-option-set" <?php echo $show_footer_title_standard_font;?>>
                            ...
                            <div class="column one-half last bpanel-option-set">
                                <?php dttheme_standard_font_style( __('Sample Title Font Style', 'dt_themes'), 'mytheme[appearance][footer-title-standard-font-style]', 

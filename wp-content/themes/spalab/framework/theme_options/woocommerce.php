...
<?php  if( class_exists('woocommerce') ) : ?>
                ...
                <!-- Gift Card Page -->
                <div class="box-title"><h3><?php _e('Gift Card Email Settings','dt_themes');?></h3></div>
                <div class="box-content">
					<div class="bpanel-option-set">
                        <h6><?php _e('Email Subject','dt_themes');?></h6>
                        ...
                        <p class="note"> <?php _e('You can paste your email subject of gift card notification.','dt_themes');?> </p>
                        <div class="hr_invisible"></div>
                    
                        <h6><?php _e('Email Template','dt_themes');?></h6>
                        ...
                        <p class="note"> <?php _e('You can paste your email template of gift card notification.','dt_themes');?> </p>

                ...
                <div class="bpanel-box">
                	...
                	<div class="box-content">
                         ...
                         <div class="column one-fifth">
                             ...
                             <div data-for="<?php echo esc_attr( $i_general['checkbox'] );?>" class="checkbox-switch <?php echo $switchclass;?>"></div>                         
                             <input id="<?php echo esc_attr( $i_general['checkbox'] );?>" class="hidden" type="checkbox" name="mytheme[integration][<?php echo $i_general['checkbox'];?>]" 
                        ...
                        <div class="column four-fifth last">
                            <p class="note no-margin"><?php echo esc_attr( $i_general['tooltip'] );?></p>
                        </div>  
                    ...
                    <div class="bpanel-box">
                        ...
                        <div class="box-content">
                            ...
                            <div class="column one-fifth">
								...
								<div data-for="<?php echo esc_attr( $i_post['checkbox'] );?>" class="checkbox-switch <?php echo $switchclass;?>"></div>
        	                    <input id="<?php echo esc_attr( $i_post['checkbox'] );?>" class="hidden" type="checkbox" name="mytheme[integration][<?php echo $i_post['checkbox'];?>]"
                         ...
                         <label><?php echo $social_bookmark["label"];?></label>
                            ...
                            <?php if( array_key_exists("options",$social_bookmark)):?>
                                ...
                                <?php 	foreach($social_bookmark['options'] as $key => $value):
                                            ...
                                            <option value="<?php echo esc_attr( $key )?>" <?php echo $rs;?>><?php echo $value?></option>
                                <?php	endforeach;?>
                                </select>                                
                            <?php endif;?>
                            ...
                            <?php if(array_key_exists("color-scheme",$social_bookmark)): ?>
                                ...
                                <select name="mytheme[integration][<?php echo "post-".$social_bookmark['id']."-color-scheme";?>]">
                                    <?php foreach($social_bookmark['color-scheme'] as $options):
                                            ...
                                            <option value="<?php echo esc_attr( $options )?>" <?php echo $rs;?>><?php echo $options?></option>
                                    <?php endforeach;?>
                                </select>
                            <?php endif;?>
			...
			foreach($integration_page as $i_page): ?>
                ...
                <div class="bpanel-box">
                	...
                	<div class="box-content">
						...
						<div data-for="<?php echo esc_attr( $i_page['checkbox'] );?>" class="checkbox-switch <?php echo $switchclass;?>"></div>
                        <input id="<?php echo esc_attr( $i_page['checkbox'] );?>" class="hidden" type="checkbox" name="mytheme[integration][<?php echo $i_page['checkbox'];?>]" 

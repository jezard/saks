	...
	function widget($args, $instance) {
		...
		echo "<div class='recent-posts-widget'><ul>";		
			 ...
			 while(have_posts()):
				...
				echo "<div class='post-thumb'>";
						...
						if( $image != false ):
							...
							if( $enable_placeholder ):
								$image = "http://placehold.it/100x80&text=Image";
							endif;
						endif;
				...
				echo "<p>";
				comments_popup_link(__('<span class="fa fa-comments"> </span> 0','dt_themes'),__('<span class="fa fa-comments"> </span> 1','dt_themes'),' <span class="fa fa-comments"> </span> % ',""
									,__('<span class="fa fa-comments-o"> </span>','dt_themes'));
				echo "</p>";
				echo "</div>";				
